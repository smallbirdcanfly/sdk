...
/**
 * 鲨游嗨嗨渠道--同zhiyou渠道一致 渠道号:47
 * 
 * @author zhj
 * 
 */
public class SYHHChannel extends PYWPlugin {
	private String uid;
	...
	private void initSDK(Activity act) {
		try {
			// app_id=04681b236644261283c2bf6a9dd966d0
			// app_key=52eaf40b2c9c6f7ae709d7b5e896d6aa
			// server_key=31addaaf5e38027fb50ff20d58b6bc27
			SboranSdkSetting zySdkSetting = new SboranSdkSetting();
			// 设置APPID
			zySdkSetting.setAppid("04681b236644261283c2bf6a9dd966d0");

			// 设置APPKEY
			zySdkSetting.setAppkey("52eaf40b2c9c6f7ae709d7b5e896d6aa");
