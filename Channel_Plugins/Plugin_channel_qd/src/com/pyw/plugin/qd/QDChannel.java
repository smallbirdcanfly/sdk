...
public class QDChannel extends PYWPlugin {
	...
	public void getRoleMessage(Context context, HashMap params,
		...
		sid = TextUtils.isEmpty(params.get("serverArea") + "") ? "1" : params
				.get("serverArea") + "";
		String level = (TextUtils.isEmpty(params.get("roleLevel") + "") ? ""
				: params.get("roleLevel")) + "";

		RoleInfo data = new RoleInfo();
		data.setRole_name(TextUtils.isEmpty(params.get("roleName") + "") ? ""
				: params.get("roleName") + "");
		data.setRole_id(TextUtils.isEmpty(params.get("roleid") + "") ? ""
				: params.get("roleid") + "");
		data.setRole_level(Integer.valueOf(level));
		data.setServer_name(TextUtils.isEmpty(params.get("serverAreaName") + "") ? ""
