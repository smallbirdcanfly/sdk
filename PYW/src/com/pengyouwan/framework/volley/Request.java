...
import com.pengyouwan.framework.volley.VolleyLog.MarkerLog;
...
public abstract class Request<T> implements Comparable<Request<T>> {
     ...
     *
     * @deprecated Use
     *             {@link #Request(int, String, com.pywsdk.volley.Response.ErrorListener)}
     *             .
     */
    @Deprecated
    ...
    /**
     * @return this request's {@link com.pywsdk.volley.Response.ErrorListener}.
     */
    ...
    private byte[] encodeParameters(Map<String, String> params, String paramsEncoding) {
        ...
        try {
            for (Map.Entry<String, String> entry : params.entrySet()) {
                ...
                // paramsEncoding));
                // encodedParams.append('&');
                jobj.put(URLEncoder.encode(entry.getKey(), paramsEncoding),
                        entry.getValue());
            }
            jarry.put(jobj);
            String reqParm = jarry.toString();
            LogUtil.d("request", reqParm);
            String str = new String(SdkUtil.encode(reqParm.getBytes("ISO-8859-1")), "ISO-8859-1");
            String reqStr = "param=" + URLEncoder.encode(str, "ISO-8859-1");
