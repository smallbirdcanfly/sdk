...
import com.pengyouwan.framework.volley.Request.Method;
...
public class HurlStack implements HttpStack {
	...
	public interface UrlRewriter {
		/**
		 * Returns a URL to use instead of the provided one, or null to indicate this
		 * URL should not be used at all.
		 */
	...
	/* package */ static void setConnectionParametersForRequest(HttpURLConnection connection, Request<?> request)
		...
		case Method.DEPRECATED_GET_OR_POST:
			...
			break;
		case Method.GET:
			// Not necessary to set the request method because connection defaults to GET
			// but
			// being explicit here.
